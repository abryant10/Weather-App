...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n\n\n\nconst KtoF = function KtoF(k) {\n  const f = Math.round((k - 273.15) * (9 / 5) + 32);\n  return f;\n};\n\nconst getData = async function getData(loc) {\n  const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${loc}&appid=49678917ded9e2b299f94f0ea74ded42`);\n\n  const data = await response.json();\n\n  console.log(data);\n\n  _dom__WEBPACK_IMPORTED_MODULE_1__.location.innerHTML = data.name;\n\n  _dom__WEBPACK_IMPORTED_MODULE_1__.weatherDescription.innerHTML = data.weather[0].description;\n\n  _dom__WEBPACK_IMPORTED_MODULE_1__.currentTemp.innerHTML = KtoF(data.main.temp);\n\n  _dom__WEBPACK_IMPORTED_MODULE_1__.highLow.innerHTML = `H:${KtoF(data.main.temp_max)} L:${KtoF(data.main.temp_min)}`;\n};\n\ngetData('dallas');\n\n\n//# sourceURL=webpack://weather-app/./src/index.js?");
